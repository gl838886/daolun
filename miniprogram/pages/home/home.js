...
Page({
    ...
    //     this.timer = setInterval(function draw() {
    //       // 设置坐标轴原点为窗口的中心点
    ...
    //       // 绘制大圆
    //       ctx.setLineWidth(1)  // 设置线条的粗细，单位px
    ...
    //         ctx.beginPath()
    //         ctx.moveTo(radius, 0)
    //         ctx.lineTo(radius - 10, 0) // 大刻度长度15px
    //         ctx.stroke()
    //       }
    ...
    //         ctx.beginPath()
    //         ctx.moveTo(radius, 0)
    //         ctx.lineTo(radius - 6, 0) // 小刻度盘长度10px
    //         ctx.stroke()
    //       }
